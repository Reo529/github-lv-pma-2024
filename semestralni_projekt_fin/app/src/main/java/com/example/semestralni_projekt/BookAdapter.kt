...
import com.example.semestralni_projekt.databinding.ItemBookBinding
        ...
        fun bind(book: Book) {
            ...
            if (categoryId != null) {
                lifecycleScope.launch {
                    ...
                    binding.bookCategory.text = category?.name ?: "Neznámý žánr"
                }
            } else {
                binding.bookCategory.text = "Bez žánru"
            }
